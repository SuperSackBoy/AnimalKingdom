...
public class CardDeck {
    ...
    public static void deckReset() {
            ...
            cardList.add(new Card("Arctic Fox", "imageAssets/cardSprites/ArcticFoxCard.png", 15, 15, 2));
            ...
            cardList.add(new Card("Wolf", "imageAssets/cardSprites/WolfCard.png", 20, 10, 2));
